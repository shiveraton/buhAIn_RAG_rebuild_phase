...
class Command(BaseCommand):
    ...
    def create_articles(self):
        ...
        # Get categories
    history_cat = CodexCategory.objects.get(name='History & Origins')
    script_cat = CodexCategory.objects.get(name='Script & Characters')
    cultural_cat = CodexCategory.objects.get(name='Cultural Significance')
    modern_cat = CodexCategory.objects.get(name='Modern Applications')
    regional_cat = CodexCategory.objects.get(name='Regional Variations')
    learning_cat = CodexCategory.objects.get(name='Learning Resources')
    ...
    for article_data in articles_data:
        article, created = CodexArticle.objects.get_or_create(
...
def create_timeline(self):
    ...
    for event_data in timeline_data:
        event, created = CodexTimeline.objects.get_or_create(
...
def create_glossary(self):
    ...
    for term_data in glossary_data:
        term, created = CodexGlossary.objects.get_or_create(
            term=term_data['term'],
            defaults=term_data
        )
        if created:
