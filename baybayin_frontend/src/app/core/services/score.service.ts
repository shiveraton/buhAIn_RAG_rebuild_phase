...
//     if (!currentUser) {
//       // For guest users, don't show annoying sign-in messages
//       // Just silently skip point awarding
//       // this.showGuestMessage();
//       return false;
//     }

//     try {
//       await this.authenticationService.updateUserScore(currentUser.uid, points);
